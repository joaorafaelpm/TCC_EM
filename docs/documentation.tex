...
A PePi tem o objetivo de ajudar os donos de restaurante do dia a dia a organizarem seu proprio negócio, e nós fazemos isso assegurando que nossa plataforma vai oferecer todo o suporte necessário para administrar o negócio
...
\begin{itemize}
    ...
    \item Idealizar um campo de gerenciamento do próprio negócio ; 
