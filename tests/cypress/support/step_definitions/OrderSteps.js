...
// ================= ASSERTIONS (THEN) =================
Then(
  "I should receive a response with status code from endpoint orders {string}",
  (statusCode) => {
...
Then(
  "I should receive a response body with status from endpoint orders {string}",
  (status) => {
    cy.get("@apiResponse").then((response) => {
...
Then(
  "I should receive a response body with title from endpoint orders {string}",
  (title) => {
    cy.get("@apiResponse").then((response) => {
...
Then(
  "I should receive a response body with detail from endpoint orders {string}",
  (detail) => {
    cy.get("@apiResponse").then((response) => {
...
Then("I should receive an array in endpoint orders", () => {
  cy.get("@apiResponse").then((response) => {
    expect(response.body._embedded.orders).to.be.an("array");
  });
});

Then(
  "I should receive a response with statusText from endpoint orders {string}",
  (statusText) => {
    cy.get("@apiResponse").then((response) => {
...
Then(
  "I should receive a response body with objects name from endpoint orders {string}",
  (objectName) => {
    cy.get("@apiResponse").then((response) => {
...
Then(
  "I should receive a response body with objects userMessage from endpoint orders {string}",
  (objectUserMessage) => {
    cy.get("@apiResponse").then((response) => {
