...
(UUID_TO_BIN(UUID()), 'São Paulo',      (SELECT id FROM state WHERE name = 'São Paulo' LIMIT 1)),
(UUID_TO_BIN(UUID()), 'Campinas',       (SELECT id FROM state WHERE name = 'São Paulo' LIMIT 1)),
...
insert into permission (id, name, description) values (UUID_TO_BIN(UUID()), 'EDITAR_COZINHAS', 'Permite editar cozinhas');
insert into permission (id, name, description) values (UUID_TO_BIN(UUID()), 'EDITAR_FORMAS_PAGAMENTO', 'Permite criar ou editar formas de pagamento');
insert into permission (id, name, description) values (UUID_TO_BIN(UUID()), 'EDITAR_CIDADES', 'Permite criar ou editar cidades');
insert into permission (id, name, description) values (UUID_TO_BIN(UUID()), 'EDITAR_ESTADOS', 'Permite criar ou editar estados');
insert into permission (id, name, description) values (UUID_TO_BIN(UUID()), 'CONSULTAR_USUARIOS_GRUPOS_PERMISSOES', 'Permite consultar usuários');
insert into permission (id, name, description) values (UUID_TO_BIN(UUID()), 'EDITAR_USUARIOS_GRUPOS_PERMISSOES', 'Permite criar ou editar usuários');
insert into permission (id, name, description) values (UUID_TO_BIN(UUID()), 'EDITAR_RESTAURANTES', 'Permite criar, editar ou gerenciar restaurantes');
...
(UUID_TO_BIN(UUID()), 'João da Silva', 'joao.ger@pendezzapizza.com', '$2a$12$xM3T9jhJ/qTbQ8yKkFyapOJeD.xzlaOB.CIgaKUBBsSfxw2dAbzM6'),
(UUID_TO_BIN(UUID()), 'Maria Joaquina', 'maria.vnd@pendezzapizza.com', '$2a$12$xM3T9jhJ/qTbQ8yKkFyapOJeD.xzlaOB.CIgaKUBBsSfxw2dAbzM6'),
(UUID_TO_BIN(UUID()), 'Roberto fazbear', 'guinas.sec@pendezzapizza.com', '$2a$12$xM3T9jhJ/qTbQ8yKkFyapOJeD.xzlaOB.CIgaKUBBsSfxw2dAbzM6'),
...
'Massa fresca, ragu de carne bovina, molho bechamel e muito queijo gratinado.', 58.00, 1
FROM restaurant r WHERE r.name = 'Trattoria da Mamma' LIMIT 1;

INSERT INTO product (id, restaurant_id, name, description, price, active)
SELECT UUID_TO_BIN(UUID()), r.id, 'Fettuccine Alfredo',
'Fettuccine artesanal com molho cremoso de manteiga e parmesão de 24 meses.', 45.50, 1
FROM restaurant r WHERE r.name = 'Trattoria da Mamma' LIMIT 1;

-- 2. Pasta & Vino
INSERT INTO product (id, restaurant_id, name, description, price, active)
SELECT UUID_TO_BIN(UUID()), r.id, 'Spaghetti alla Carbonara',
'A autêntica receita romana com guanciale, gemas de ovos e queijo pecorino.', 52.00, 1
FROM restaurant r WHERE r.name = 'Pasta & Vino' LIMIT 1;

INSERT INTO product (id, restaurant_id, name, description, price, active)
SELECT UUID_TO_BIN(UUID()), r.id, 'Risotto ai Funghi',
'Arroz arbóreo, mix de cogumelos frescos e finalizado com azeite de trufas.', 64.90, 1
FROM restaurant r WHERE r.name = 'Pasta & Vino' LIMIT 1;
...
'Molho de tomate, mozzarella, salame picante italiano e cebola roxa.', 54.00, 1
FROM restaurant r WHERE r.name = 'Pizzeria Napoli Centrale' LIMIT 1;

-- 4. Osteria del Porto
INSERT INTO product (id, restaurant_id, name, description, price, active)
SELECT UUID_TO_BIN(UUID()), r.id, 'Spaghetti allo Scoglio',
'Massa com frutos do mar (camarão, lula e mariscos) ao molho de vinho branco.', 78.00, 1
FROM restaurant r WHERE r.name = 'Osteria del Porto' LIMIT 1;

INSERT INTO product (id, restaurant_id, name, description, price, active)
SELECT UUID_TO_BIN(UUID()), r.id, 'Tiramisù Clássico',
'Sobremesa de biscoito champagne embebido em café com creme de mascarpone.', 28.00, 1
FROM restaurant r WHERE r.name = 'Osteria del Porto' LIMIT 1;
...
SELECT
    ...
    (SELECT id FROM city WHERE name = 'São Paulo' LIMIT 1),
    'Rua das Laranjeiras', '500', 'Aclimação', '01537-000';
...
SELECT
    ...
    (SELECT id FROM city WHERE name = 'Rio de Janeiro' LIMIT 1),
    'Rua Visconde de Pirajá', '120', 'Ipanema', '22410-003';
...
values ('af5aa5c3-e3de-430d-9251-1682d9329280', 'pendezzapizza-commom-client', '2026-01-25 14:44:40', '$2a$12$48T2NXd/.auET2UoPNYT8enHWRKuzlt1bhwdbZHgxpElMn4VTGaUu', NULL, 'af5aa5c3-e3de-430d-9251-1682d9329280', 'client_secret_basic', 'refresh_token,authorization_code', 'http://localhost:80/redirect', 'READ,WRITE', '{\"@class\":\"java.util.Collections$UnmodifiableMap\",\"settings.client.require-proof-key\":true,\"settings.client.require-authorization-consent\":true}', '{\"@class\":\"java.util.Collections$UnmodifiableMap\",\"settings.token.reuse-refresh-tokens\":false,\"settings.token.x509-certificate-bound-access-tokens\":false,\"settings.token.id-token-signature-algorithm\":[\"org.springframework.security.oauth2.jose.jws.SignatureAlgorithm\",\"RS256\"],\"settings.token.access-token-time-to-live\":[\"java.time.Duration\",1800.000000000],\"settings.token.access-token-format\":{\"@class\":\"org.springframework.security.oauth2.server.authorization.settings.OAuth2TokenFormat\",\"value\":\"self-contained\"},\"settings.token.refresh-token-time-to-live\":[\"java.time.Duration\",2592000.000000000],\"settings.token.authorization-code-time-to-live\":[\"java.time.Duration\",300.000000000],\"settings.token.device-code-time-to-live\":[\"java.time.Duration\",300.000000000]}', ''),
('a97d2554-0128-4307-9f41-f6659cf1091b', 'pendezzapizza-web', '2026-01-25 14:44:40', '$2a$12$pI6u.WC.Lh/d3oSTmjQewufL2majI8t43Iwv59hZQjz5UogcYHzUC', NULL, 'a97d2554-0128-4307-9f41-f6659cf1091b', 'client_secret_basic', 'refresh_token,authorization_code', 'http://localhost:80/redirect', 'READ,WRITE', '{\"@class\":\"java.util.Collections$UnmodifiableMap\",\"settings.client.require-proof-key\":true,\"settings.client.require-authorization-consent\":true}', '{\"@class\":\"java.util.Collections$UnmodifiableMap\",\"settings.token.reuse-refresh-tokens\":false,\"settings.token.x509-certificate-bound-access-tokens\":false,\"settings.token.id-token-signature-algorithm\":[\"org.springframework.security.oauth2.jose.jws.SignatureAlgorithm\",\"RS256\"],\"settings.token.access-token-time-to-live\":[\"java.time.Duration\",1800.000000000],\"settings.token.access-token-format\":{\"@class\":\"org.springframework.security.oauth2.server.authorization.settings.OAuth2TokenFormat\",\"value\":\"self-contained\"},\"settings.token.refresh-token-time-to-live\":[\"java.time.Duration\",2592000.000000000],\"settings.token.authorization-code-time-to-live\":[\"java.time.Duration\",300.000000000],\"settings.token.device-code-time-to-live\":[\"java.time.Duration\",300.000000000]}', ''),
('5ad789dc-d6c6-45c6-81e6-248892cffa7d', 'pendezzapizza-doc', '2026-01-25 14:44:40', '$2a$12$3K81IleIYCdK7sk7tmXSWOqF0nng.HFeI.qPiPa/rpInY/XhGnnp6', NULL, '5ad789dc-d6c6-45c6-81e6-248892cffa7d', 'client_secret_basic', 'refresh_token,authorization_code', 'http://localhost/swagger-ui/index.html', 'READ,WRITE', '{\"@class\":\"java.util.Collections$UnmodifiableMap\",\"settings.client.require-proof-key\":true,\"settings.client.require-authorization-consent\":true}', '{\"@class\":\"java.util.Collections$UnmodifiableMap\",\"settings.token.reuse-refresh-tokens\":false,\"settings.token.x509-certificate-bound-access-tokens\":false,\"settings.token.id-token-signature-algorithm\":[\"org.springframework.security.oauth2.jose.jws.SignatureAlgorithm\",\"RS256\"],\"settings.token.access-token-time-to-live\":[\"java.time.Duration\",1800.000000000],\"settings.token.access-token-format\":{\"@class\":\"org.springframework.security.oauth2.server.authorization.settings.OAuth2TokenFormat\",\"value\":\"self-contained\"},\"settings.token.refresh-token-time-to-live\":[\"java.time.Duration\",2592000.000000000],\"settings.token.authorization-code-time-to-live\":[\"java.time.Duration\",300.000000000],\"settings.token.device-code-time-to-live\":[\"java.time.Duration\",300.000000000]}', ''),
('5281d8fd-856c-417b-94c3-ac8fc13a4758', 'pendezzapizza-end', '2026-01-25 14:44:40', '$2a$12$eEF1poMf6bOVVd/P6Q9JI.116IjvRAFqgVD5dYubKr3Z00RiMaCLS', NULL, '5281d8fd-856c-417b-94c3-ac8fc13a4758', 'client_secret_basic', 'refresh_token,authorization_code', 'http://localhost:80/redirect', 'READ,WRITE', '{\"@class\":\"java.util.Collections$UnmodifiableMap\",\"settings.client.require-proof-key\":true,\"settings.client.require-authorization-consent\":true}', '{\"@class\":\"java.util.Collections$UnmodifiableMap\",\"settings.token.reuse-refresh-tokens\":false,\"settings.token.x509-certificate-bound-access-tokens\":false,\"settings.token.id-token-signature-algorithm\":[\"org.springframework.security.oauth2.jose.jws.SignatureAlgorithm\",\"RS256\"],\"settings.token.access-token-time-to-live\":[\"java.time.Duration\",1800.000000000],\"settings.token.access-token-format\":{\"@class\":\"org.springframework.security.oauth2.server.authorization.settings.OAuth2TokenFormat\",\"value\":\"self-contained\"},\"settings.token.refresh-token-time-to-live\":[\"java.time.Duration\",2592000.000000000],\"settings.token.authorization-code-time-to-live\":[\"java.time.Duration\",300.000000000],\"settings.token.device-code-time-to-live\":[\"java.time.Duration\",300.000000000]}', '');
