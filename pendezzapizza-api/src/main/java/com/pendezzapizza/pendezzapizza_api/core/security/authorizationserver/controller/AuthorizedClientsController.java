...
import com.pendezzapizza.pendezzapizza_api.core.security.authorizationserver.OAuth2AuthorizationQueryService;
...
public class AuthorizedClientsController {
    ...
    public String revoke(Principal principal,
        ...
        this.oAuth2AuthorizationQueryService.deleteAuthorizations(principal.getName(), registeredClient.getId());
