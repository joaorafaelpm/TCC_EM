...
public interface RestaurantUserControllerOpenApi {
    ...
    ResponseEntity<Page<UserModel>> list(@Parameter(example = "943af7ca-3ae8-41fa-a1b0-5cd1d9f82e48", description = "Id do restaurante", required = true) UUID restaurantId,
